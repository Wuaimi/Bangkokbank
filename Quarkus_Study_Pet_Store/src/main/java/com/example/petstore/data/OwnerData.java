...
public class OwnerData {
    ...
    // public boolean addPetToOwner(Integer petId, Integer ownerId) {
    //     for (Owner o : ownerList) {
    //         if (o.getOwnerId().equals(ownerId)) {
    //             if (!o.getOwnerPets().contains(petId)) { // Prevent duplicate pet IDs
    //                 o.getOwnerPets().add(petId);
    //                 return true;
    //             }
    //             return false; // Pet already assigned to owner
    //         }
    //     }
    //     return false;
    // }

    public boolean removePetFromOwner(Integer petId, Integer ownerId) {
        for (Owner o : ownerList) {
            if (o.getOwnerId().equals(ownerId)) {
                return o.getOwnerPets().remove(petId); // Only returns true if petId existed
            }
        }
        return false;
    }
